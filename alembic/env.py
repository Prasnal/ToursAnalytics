...
def run_migrations_online() -> None:
    ...
    url_tokens = {
        "RAW_DATA_POSTGRESQL_USER": os.getenv("RAW_DATA_POSTGRESQL_USER", ""),
        "RAW_DATA_POSTGRESQL_PASS": os.getenv("RAW_DATA_POSTGRESQL_PASS", ""),
        "RAW_DATA_POSTGRESQL_ADDR": os.getenv("RAW_DATA_POSTGRESQL_ADDR", ""),
        "RAW_DATA_POSTGRESQL_NAME": os.getenv("RAW_DATA_POSTGRESQL_NAME", "")
    }
